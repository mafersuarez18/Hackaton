        ...
        <div className="w-full max-w-4xl">
          <div className="bg-[rgba(255,255,255,0.45)] rounded-lg p-12 shadow-2xl mx-auto text-center" style={{ backdropFilter: 'blur(6px)' }}>
            ...
            <div className="flex items-center justify-center space-x-6">
              <button onClick={onLogin} className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-10 py-3 rounded-full">Entrar</button>
              <button onClick={onLogin} className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-10 py-3 rounded-full">Olvidó la contraseña</button>
            </div>
          </div>
        </div>
      </div>
